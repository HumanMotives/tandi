...
// ——————————————————————————————————————————————
// PUBLIC: called by the “Play” button in index.html
// ——————————————————————————————————————————————
let chordLoop;
async function startDroneLoop() {
  // map freqVal → 10–120 BPM, start transport & chord loop
...
function draw() {
  ...
  // exponential time-scale for near-freeze at low speed
...
function touchMoved() {
  if (touches.length === 1) {
    ...
    noiseVal = foldVal = v;
    // fade noise in/out very subtly over 2s at max 2%
